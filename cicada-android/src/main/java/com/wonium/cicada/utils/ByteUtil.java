...
public enum ByteUtil {
     ...
     * @return byte[]
     */
    public byte[] shortToByteArray(short value, ByteOrder endian) {
     ...
     * @return int
     */
    public int byteArrayToInt(byte[] bytes, ByteOrder endian) {
        int maxLength = 4;
        if (bytes.length != maxLength) {
     ...
     * @return bytes byte[]
     */
    public byte[] intToByteArray(int value, ByteOrder endian) {
     ...
     * @return value float
     */
    public float byteArrayToFloat(byte[] bytes, ByteOrder endian) {
        int maxLength = 4;
        if (bytes.length != maxLength) {
     ...
     * @param endian
     */
    public long byteArrayToLong(byte[] bytes, ByteOrder endian) {
        if (bytes.length != 8) {
            throw new IndexOutOfBoundsException("the byte array b index out of bounds ");
        }
     ...
     * @return byte[] 字节数组
     */
    public byte[] longToByteArray(long value, ByteOrder endian) {
