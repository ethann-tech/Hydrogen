...
package com.wonium.aclj.presenter.impl;


import com.wonium.aclj.model.BaseModel;
import com.wonium.aclj.model.StringModel;
import com.wonium.aclj.model.impl.StringModelImpl;
...
public class StringPresenterImpl implements StringPresenter {
    ...
    public  void valueOf(String charachter) {
        if (mStringView!=null){
            if (StringUtil.getInstance().isNull(charachter)) {
