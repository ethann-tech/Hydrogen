...
public class MyWorkAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (isExpanded) {
            mGroupViewHolder.groupIndicator.setBackgroundResource(com.ethan.hydrogen.R.drawable.ic_arrow_down);
        } else {
            mGroupViewHolder.groupIndicator.setBackgroundResource(com.ethan.hydrogen.R.drawable.ic_arrow_list_expand_right_24dp);
        }
        return convertView;
    }
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        if (convertView == null) {
            ...
            // 内部类绑定相应控件
            convertView = mLayoutInflater.inflate(R.layout.item_work_childs, parent,
                    false);
