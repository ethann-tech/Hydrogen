...
class BarView extends View implements Determinate {
    ...
    private void init() {
        ...
        mOuterPaint.setStrokeWidth(DensityUtil.getInstance().dip2px(getContext(),2));
        ...
        mBoundGap =DensityUtil.getInstance().dip2px(getContext(),5);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int padding = DensityUtil.getInstance().dip2px(getContext(),2);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthDimension =DensityUtil.getInstance().dip2px(getContext(),100);
        int heightDimension =DensityUtil.getInstance().dip2px(getContext(),20);
