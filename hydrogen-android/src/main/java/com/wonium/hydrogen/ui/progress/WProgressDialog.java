...
package com.wonium.hydrogen.ui.progress;
...
public class WProgressDialog {
     ...
     */
    public static WProgressDialog create(Context context) {
        return new WProgressDialog(context);
    }
   ...
   * @return An unique HUD instance
   */
    public static WProgressDialog create(Context context, Style style) {
        return new WProgressDialog(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public WProgressDialog setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public WProgressDialog setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public WProgressDialog setSize(int width, int height) {
     ...
     */
    @Deprecated
    public WProgressDialog setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public WProgressDialog setBackgroundColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public WProgressDialog setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public WProgressDialog setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public WProgressDialog setLabel(String label) {
     ...
     * @return Current HUD
     */
    public WProgressDialog setLabel(String label, int color) {
     ...
     * @return Current HUD
     */
    public WProgressDialog setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public WProgressDialog setDetailsLabel(String detailsLabel, int color) {
     ...
     * @return Current HUD
     */
    public WProgressDialog setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public WProgressDialog setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public WProgressDialog setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public WProgressDialog setCancellable(DialogInterface.OnCancelListener listener) {
     ...
     * @return Current HUD
     */
    public WProgressDialog setAutoDismiss(boolean isAutoDismiss) {
     ...
     * @return Current HUD
     */
    public WProgressDialog setGraceTime(int graceTimeMs) {
        mGraceTimeMs = graceTimeMs;
        return this;
    }

    public WProgressDialog show() {
        if (!isShowing()) {
            mFinished = false;
            if (mGraceTimeMs == 0) {
    ...
    private class ProgressDialog extends Dialog {
        ...
        private void updateBackgroundSize() {
            ...
            params.width = DensityUtil.getInstance().dip2px(getContext(),mWidth);
            params.height = DensityUtil.getInstance().dip2px(getContext(),mHeight);
