...
public class CircleImageView extends AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShowFlag && mFlagText != null) {
            ...
            canvas.drawText(mFlagText, getWidth() / 2F, (float) ((3 + Math.cos((Math.PI * 5 / 18))) * getHeight() / 4 + mFlagTextBounds.height() / 3), mFlagTextPaint);
        }
...
//        mSweepGradient = new SweepGradient(getWidth() / 2F, getHeight() / 2F, new int[]{Color.rgb(255, 255, 255), Color.rgb(1, 209, 255)}, null);
